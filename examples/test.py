...
if __name__ == "__main__":
    ...
    out_path = input_file.replace(".wav", "_ten_vad_pred.csv")
    sr, data = Wavfile.read(input_file)
    hop_size = 500  # 16 ms per frame
    threshold = 0.5
